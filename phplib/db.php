...
function sendAuthenticationEmail($email, $name, $publicTic) {
	$to = $email;
	$subject = Str::get("$name-subject", array(Config::$appname));
	$message = Str::get("$name-message", array(Config::$appname, Config::$appnameLong, $publicTic));
